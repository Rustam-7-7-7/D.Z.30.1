# Домашнее задание 30.1-35.2

## Описание:

Домашнее задание 30.1-35.2 - это проект, целью которого 
...
## В рамках домашнего задания 35.2 выполнены следующие задачи:

### Задание 1
Настройте удаленный сервер для работы с веб-приложением.
